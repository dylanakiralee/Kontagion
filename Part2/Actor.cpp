...
DirtPile::DirtPile(double x, double y, StudentWorld* world)
	: Actor(0, IID_DIRT, x, y, 0, 1, world) {
...
Food::Food(double x, double y, StudentWorld* world)
	: Actor(0, IID_FOOD, x, y, 90, 1, world) {
